  ...
  <section class="section">
    <div class="columns is-centered">
      <form class="column is-half" @submit="saveFabric">
        ...
        >
          <b-input v-model="form.box.field" type="number" required />
        </b-field>
        <b-field
          ...
          :type="{ 'is-danger': form.box.error }"
        >
          <b-input v-model="form.material.field" required />
        </b-field>
        <b-field
        ...
        >
          <b-input v-model="form.pattern.field" required />
        </b-field>
        <b-field
        ...
        >
          <b-input v-model="form.state.field" required />
        </b-field>
        <b-field
        ...
        >
          <b-input v-model="form.thickness.field" required />
        </b-field>
        <b-field
        ...
        >
          <b-input v-model="form.width.field" type="number" />
        </b-field>
        <b-field
        ...
        >
          <b-input v-model="form.length.field" type="number" />
        </b-field>
        <b-field
        ...
        >
          <div class="columns colors">
            <div v-for="color in colors" :key="color.id" class="column is-6">
              <color-field
